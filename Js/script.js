...
function playBackgroundMusic() {
  ...
  if (musicaParam) {
    ...
    console.log("🎵 Música desde URL:", audio.src);
  } else {
    // Usar la música por defecto
    audio.src = 'Music/Boywithuke - Scared Of The Dark (Sub. Español).mp3';
    console.log("🎵 Música por defecto cargada:", audio.src);
  }
  ...
  console.log("✅ Sistema de música configurado");
}
